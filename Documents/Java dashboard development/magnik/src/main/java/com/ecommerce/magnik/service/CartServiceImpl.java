...
import com.ecommerce.magnik.repositories.CartItemRepository;
...
//                    return productDTO;
    ...
    public List<CartDTO> getAllCarts() {
        ...
        List<CartDTO> cartDTOs = carts.stream().map(cart -> {
            ...
            List<ProductDTO> products = cart.getCartItems().stream()
                    .map(cartItemm -> {
                        ProductDTO productDTO = modelMapper.map(cartItemm.getProduct(), ProductDTO.class);
                        productDTO.setQuantity(cartItemm.getQuantity());
                        return productDTO;
                    }).collect(Collectors.toList());
    ...
    public CartDTO getCart(String emailId, Long cartId) {
        ...
        // Map each CartItem's Product to ProductDTO and set the quantity directly
        List<ProductDTO> products = cart.getCartItems().stream()
                .map(cartItem -> {
